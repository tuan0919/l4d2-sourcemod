...
// ====================================================================================================
bool g_bMap_l4d2_stadium5_stadium;
...
public void OnMapStart()
{
    ...
    g_bMap_l4d2_stadium5_stadium = (StrEqual(mapName, "l4d2_stadium5_stadium", false));
...
void SetSpecialInfectedModel(int entity, int zombieclass)
{
    ...
    switch (zombieclass)
    {
        ...
        {
            if (g_bMap_l4d2_stadium5_stadium) // Suicide Blitz 2 finale is hardcoded in vscript based on Tank model
                return;
