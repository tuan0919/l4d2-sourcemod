...
1. `scripting/l4d2_elite_si_core.sp`
   - Nguon su that cho Elite SI (roll elite, HP multiplier, Tank HP multiplier rieng, mau render, subtype API)
   - Expose native:
...
4. Neu thanh Elite:
   - buff HP: non-Tank theo `l4d2_elite_si_core_hp_multiplier`, Tank theo `l4d2_elite_si_core_tank_hp_multiplier` (mac dinh 1.2)
...
- Update Web UI + `cfg/sourcemod/l4d2_elite_si_core.cfg` de hien thi, load va save cvar Tank HP multiplier moi.
